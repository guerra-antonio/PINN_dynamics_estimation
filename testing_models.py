...
# First, we test models up to 6 qubits
for N_qbits in list(range(2, 7)):
    for close_U in [True, False]:
        print(f"Testing model with {N_qbits} qubits and close_U = {close_U}...")
        ...
        model_01.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-0.1.pth', map_location='cpu'))
        model_025.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-0.25.pth', map_location='cpu'))
        model_05.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-0.5.pth', map_location='cpu'))
        model_10.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-1.0.pth', map_location='cpu'))
...
# Secondly, we test models of 7 and 8 qubits
for N_qbits in list(range(7, 9)):
    for method in ["magnus", "trotter"]:
        print(f"Testing model with {N_qbits} qubits and using {method}...")
        ...
        # Load the trained weights
        model_01.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-0.1-{method}.pth', map_location='cpu'))
        model_025.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-0.25-{method}.pth', map_location='cpu'))
        model_05.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-0.5-{method}.pth', map_location='cpu'))
        model_10.load_state_dict(torch.load(f'models/models-full-loss/model{N_qbits}_deltat-1.0-{method}.pth', map_location='cpu'))
